...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Flutter Demo Home Page 5121'),
    );
  }
}
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text('1 Min', textAlign: TextAlign.right),
            Row(
            ...
            Row(
                ...
                children: const <Widget>[
                  Text('testRow', textAlign: TextAlign.left),
                  Expanded(
                    child: Text("OK", textAlign: TextAlign.right),

                  ),
                  Text('  1 Min', textAlign: TextAlign.right),
